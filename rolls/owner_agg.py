...
owner_df = df.select("COUNTY", "SOURCE_INFO_DATE", "OWNER_NAME", "MA_STREET_ADDRESS", "MA_CITY", "MA_STATE", "MA_UNIT_NUMBER",
                           "MA_ZIP_CODE", "MA_ZIP_CODE_EXTENSION", "MA_CARE_OF", "MA_ATTN_NAME", "PARCEL_ID")
...
owner_df = owner_df.withColumnRenamed("MA_STREET_ADDRESS", "STREET_ADDRESS") \
                   ...
                   .withColumnRenamed("MA_ZIP_CODE", "ZIPCODE") \
                   .withColumnRenamed("MA_ZIP_CODE_EXTENSION", "ZIPCODE_EXTENSION") \
                   .withColumnRenamed("MA_CARE_OF", "CARE_OF") \
                   .withColumnRenamed("MA_ATTN_NAME", "ATTN_NAME") \

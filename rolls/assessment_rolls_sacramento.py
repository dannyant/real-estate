...
def main():
    ...
    for file in ["2023_secured_roll.txt"]:
        ...
        df = df.select("COUNTY", "PARCEL_ID", "SOURCE_INFO_DATE", "TAX_RATE_AREA", "ADDRESS_STREET_NUM", "ADDRESS_CITY", "SITUS_STREET", "SITUS_ZIP", "OWNER_CODE", "OWNER", "MAIL_ADDRESS", "MAIL_CITY", "MAIL_STATE", "MAIL_ZIP", "CARE_OF", "ZONING", "LAND_USE_CODE", "RECORDING_DATE", "RECORDING_PAGE", "DEED_TYPE", "LAND", "IM", "FIXTURE", "PP", "HO_EX", "EX", "VALUE_DT", "ACTION_CODE")

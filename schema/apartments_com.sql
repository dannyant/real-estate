...
select SOURCE_INFO_DATE, USE_TYPE, PARCEL_ID,ADDRESS_STREET_NUM, ADDRESS_STREET_NAME, ADDRESS_CITY, ADDRESS_ZIP ,
OWNER_NAME_LIST, MA_STREET_ADDRESS_LIST, HOMEOWNERS_EXEMPTION_VALUE_LIST
from ROLL_INFO_AGG where COUNTY = 'SACRAMENTO' and SOURCE_INFO_DATE = '2023' and MA_STREET_ADDRESS_CHANGE = True and OWNER_NAME_CHANGE = False and USE_TYPE in ('COMMERCIAL_RESIDENTIAL', 'RESIDENTIAL_MULTI_SF', 'RESIDENTIAL_SF');

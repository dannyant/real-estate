...
CREATE TABLE IF NOT EXISTS ROLL_INFO_AGG (
    ...
    PARCEL_ID VARCHAR,
    SOURCE_INFO_DATE VARCHAR,
    USE_TYPE_LIST VARCHAR,
    PRI_TRA_LIST VARCHAR,
    SEC_TRA_LIST VARCHAR,
    ADDRESS_STREET_NUM_LIST VARCHAR,
    ADDRESS_STREET_NAME_LIST VARCHAR,
    ADDRESS_UNIT_NUM_LIST VARCHAR,
    ADDRESS_CITY_LIST VARCHAR,
    ADDRESS_ZIP_LIST VARCHAR,
    ADDRESS_ZIP_EXTENSION_LIST VARCHAR,
    TAXES_LAND_VALUE_LIST VARCHAR,
    TAXES_IMPROVEMENT_VALUE_LIST VARCHAR,
    CLCA_LAND_VALUE_LIST VARCHAR,
    CLCA_IMPROVEMENT_VALUE_LIST VARCHAR,
    FIXTURES_VALUE_LIST VARCHAR,
    PERSONAL_PROPERTY_VALUE_LIST VARCHAR,
    HPP_VALUE_LIST VARCHAR,
    HOMEOWNERS_EXEMPTION_VALUE_LIST VARCHAR,
    OTHER_EXEMPTION_VALUE_LIST VARCHAR,
    NET_TOTAL_VALUE_LIST VARCHAR,
    LAST_DOC_PREFIX_LIST VARCHAR,
    LAST_DOC_SERIES_LIST VARCHAR,
    LAST_DOC_DATE_LIST VARCHAR,
    LAST_DOC_INPUT_DATE_LIST VARCHAR,
    OWNER_NAME_LIST VARCHAR,
    MA_CARE_OF_LIST VARCHAR,
    MA_ATTN_NAME_LIST VARCHAR,
    MA_STREET_ADDRESS_LIST VARCHAR,
    MA_UNIT_NUMBER_LIST VARCHAR,
    MA_CITY_STATE_LIST VARCHAR,
    MA_ZIP_CODE_LIST VARCHAR,
    MA_ZIP_CODE_EXTENSION_LIST VARCHAR,
    MA_BARECODE_WALK_SEQ_LIST VARCHAR,
    MA_BARCODE_CHECK_DIGIT_LIST VARCHAR,
    MA_EFFECTIVE_DATE_LIST VARCHAR,
    MA_SOURCE_CODE_LIST VARCHAR,
    USE_CODE_LIST VARCHAR,
    ECON_UNIT_FLAG_LIST VARCHAR,
    APN_INACTIVE_DATE_LIST VARCHAR,
    CONSTRAINT PARCEL_PK PRIMARY KEY (COUNTY, PARCEL_ID, SOURCE_INFO_DATE));
